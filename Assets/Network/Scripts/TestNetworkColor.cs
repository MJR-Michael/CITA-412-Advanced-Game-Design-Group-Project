...
public class TestNetworkColor : NetworkIdentity
{
    ...
    //  [ObserverRPC(bufferLast:true)]        this allows any new clients who have joined after an instruction was sent to the client, to still receive those new instructions.
    //  This is a simple level of synchronizing
